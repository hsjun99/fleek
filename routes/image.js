...
router.get(
  "/upload/profile",
  AuthUser.checkToken,
  imageController.getPresignedUrlProfile
);

router.delete(
  "/remove/profile",
  AuthUser.checkToken,
  imageController.deleteProfile
);

router.post(
  "/upload/feed",
  AuthUser.checkToken,
  imageController.getPresignedUrlFeed
);

router.delete(
  "/feed/:feed_id",
  AuthUser.checkToken,
  imageController.deleteFeedImage
);

router.put(
  "/feed/:feed_id",
  AuthUser.checkToken,
  imageController.updateFeedImageDetail
);
