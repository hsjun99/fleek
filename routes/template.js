...
router.get(
  ...
  templateController.getUserTemplateWear
);
...
router.post(
  "/default/:group_id/:index",
  AuthUser.checkToken,
  templateController.importDefaultTemplate
);

router.post(
  "/otherusers/:template_id",
  AuthUser.checkToken,
  templateController.importOtherUsersTemplate
);
...
router.post(
  "/ptrequest",
  AuthUser.checkToken,
  ptRequestController.postPTRequest
);

router.delete(
  "/ptrequest/:request_id",
  AuthUser.checkToken,
  ptRequestController.cancelPTRequest
);
