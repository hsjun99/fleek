...
router.put(
  ...
  AuthUser.checkToken,
  userController.updateHeightWeight
);
...
router.put(
  ...
  AuthUser.checkToken,
  userController.updateBodyInfoRecord
);

router.delete(
  "/bodyinfo/:body_info_id",
  AuthUser.checkToken,
  userController.deleteBodyInfo
);
...
router.get(
  "/fleekdata/self",
  AuthUser.checkToken,
  userController.getSelfFleekData
);

router.get(
  "/fleekdata/:other_uid",
  AuthUser.checkToken,
  userController.getOthersFleekData
);

router.post(
  "/privacysetting/:privacy_mode",
  AuthUser.checkToken,
  userController.updatePrivacySetting
);

router.delete("/unregister", AuthUser.checkToken, userController.unregister);

router.get(
  "/workoutmemo/:workout_id",
  AuthUser.checkToken,
  userController.getUserWorkoutMemo
);

router.post(
  "/workoutmemo/:workout_id",
  AuthUser.checkToken,
  userController.postUserWorkoutMemo
);

router.put(
  "/workoutmemo/:userWorkoutMemo_id",
  AuthUser.checkToken,
  userController.updateUserWorkoutMemo
);

router.delete(
  "/workoutmemo/:userWorkoutMemo_id",
  AuthUser.checkToken,
  userController.deleteUserWorkoutMemo
);

router.get(
  "/userhistory",
  AuthUser.checkToken,
  userHistoryController.getUserHistoryData
);

router.put(
  "/sns/instagram/:instagram_id",
  AuthUser.checkToken,
  userController.updateInstagramId
);

router.delete(
  "/sns/instagram",
  AuthUser.checkToken,
  userController.deleteInstagramId
);
