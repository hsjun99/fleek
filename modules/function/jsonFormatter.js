...
module.exports = {
    getWorkout: (id, english, korean, category, muscle_p, muscle_s, equipment, record_type, rest_time, inclination, intercept, recent_records, workout_ability, plan, detail_plan) => {
        return {
            basic_info: {
