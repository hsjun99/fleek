...
const workout = {
    ...
    postPersonalTrainingRequest: async (uid, data) => {
        const fields1 = 'userinfo_uid, request_duration, request_goal, request_train_type, request_intensity, request_content';
        const questions1 = '?, ?, ?, ?, ?, ?';
        const values1 = [uid, data.request_duration, data.request_goal, data.request_train_type, data.request_intensity, data.request_content];
